"""
Django settings for ki_energie project.
...
SECRET_KEY = 'django-insecure-x7fq@#w2%lfpf(bx)n^k4x21&aw8-q&!s%132ulo+(c2j13div'
...
WSGI_APPLICATION = 'ki_energie.wsgi.application'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "ki_energie/static"),)
